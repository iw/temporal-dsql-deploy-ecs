...
# -----------------------------------------------------------------------------
# This file creates the ECS cluster infrastructure:
...
# -----------------------------------------------------------------------------
# Note: Capacity provider is configured in ec2-cluster.tf for EC2-based deployment
# The EC2 capacity provider is associated with the cluster there.
