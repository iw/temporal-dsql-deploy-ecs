  ...
  container_definitions = jsonencode([
    {
      ...
      cpu    = var.temporal_history_cpu - 128
      memory = var.temporal_history_memory - 256
      ...
      environment = [
        ...
        # History needs larger pool - 4/16 replicas exhausted 200 conns at 400 WPS
        { name = "TEMPORAL_SQL_MAX_CONNS", value = "500" },
        { name = "TEMPORAL_SQL_MAX_IDLE_CONNS", value = "500" },
