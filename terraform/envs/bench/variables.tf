# -----------------------------------------------------------------------------
# Environment Variables - Bench Environment
# -----------------------------------------------------------------------------
# This file defines all variables needed by modules with bench-appropriate defaults.
# Bench environment uses larger resources for load testing and benchmarking.
#
# Requirements: 2.2, 2.4, 13.2
# -----------------------------------------------------------------------------
...
variable "ec2_instance_type" {
  description = "EC2 instance type for ECS cluster (ARM64 Graviton). Bench uses larger instances for load testing."
  type        = string
  default     = "m8g.4xlarge"
...
variable "ec2_instance_count" {
  description = "Number of EC2 instances in the ECS cluster. Bench uses more instances for load testing."
  type        = number
  default     = 10
...
variable "temporal_history_cpu" {
  description = "CPU units for History service. Bench uses larger allocation for load testing."
  type        = number
  default     = 4096
...
variable "temporal_history_memory" {
  description = "Memory in MB for History service. Bench uses larger allocation for load testing."
  type        = number
  default     = 8192
...
variable "temporal_history_count" {
  description = "Desired task count for History service. Bench uses WPS 200 configuration for load testing."
  type        = number
  default     = 16
...
variable "temporal_matching_cpu" {
  description = "CPU units for Matching service. Bench uses larger allocation for load testing."
  type        = number
  default     = 1024
...
variable "temporal_matching_memory" {
  description = "Memory in MB for Matching service. Bench uses larger allocation for load testing."
  type        = number
  default     = 2048
...
variable "temporal_matching_count" {
  description = "Desired task count for Matching service. Bench uses WPS 200 configuration for load testing."
  type        = number
  default     = 16
...
variable "temporal_frontend_cpu" {
  description = "CPU units for Frontend service. Bench uses larger allocation for load testing."
  type        = number
  default     = 2048
...
variable "temporal_frontend_memory" {
  description = "Memory in MB for Frontend service. Bench uses larger allocation for load testing."
  type        = number
  default     = 4096
...
variable "temporal_frontend_count" {
  description = "Desired task count for Frontend service. Bench uses WPS 200 configuration for load testing."
  type        = number
  default     = 9
...
variable "temporal_worker_cpu" {
  description = "CPU units for Worker service. Bench uses larger allocation for load testing."
  type        = number
  default     = 512
...
variable "temporal_worker_memory" {
  description = "Memory in MB for Worker service. Bench uses larger allocation for load testing."
  type        = number
  default     = 1024
...
variable "temporal_worker_count" {
  description = "Desired task count for Worker service. Bench uses WPS 200 configuration for load testing."
  type        = number
  default     = 3
...
variable "opensearch_visibility_index" {
  ...
  type        = string
  default     = "temporal_visibility_v1_bench"
}

variable "opensearch_instance_type" {
  description = "OpenSearch instance type. Bench uses larger instances for load testing."
  type        = string
  default     = "m6g.large.search"
}

variable "opensearch_instance_count" {
  description = "Number of OpenSearch instances. Bench uses more instances for load testing."
  type        = number
  default     = 3
...
variable "benchmark_enabled" {
  description = "Enable benchmark infrastructure. Enabled by default in bench environment."
  type        = bool
  default     = true
}
...
variable "benchmark_cpu" {
  description = "CPU units for benchmark task"
  type        = number
  default     = 4096
...
# in bench for load testing.
# Requirements: 17.5

variable "dsql_reservoir_enabled" {
  description = "Enable DSQL connection reservoir for rate-limit-aware connection management. Enabled in bench for load testing."
  type        = bool
  default     = true
}
...
# Enabled by default in bench for load testing.
# Requirements: 17.5

variable "dsql_distributed_conn_lease_enabled" {
  description = "Enable distributed connection leasing via DynamoDB. Enabled in bench for load testing."
  type        = bool
  default     = true
}
