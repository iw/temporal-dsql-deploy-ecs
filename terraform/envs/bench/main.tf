# -----------------------------------------------------------------------------
# Bench Environment - Module Instantiations
# -----------------------------------------------------------------------------
# This file instantiates all modules with appropriate variable values and
# wires module outputs to dependent module inputs.
#
# The bench environment includes the benchmark module for load testing.
#
# Requirements: 2.2, 2.3, 13.2
# -----------------------------------------------------------------------------
...
# BENCHMARK LAYER
# =============================================================================
# The benchmark module is enabled by default in the bench environment for
