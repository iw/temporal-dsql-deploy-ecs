...
output "deployment_summary" {
  ...
  value       = <<-EOT
    ...
    ============================================================
    TEMPORAL ECS DEPLOYMENT SUMMARY (PROD ENVIRONMENT)
    ============================================================
    ...
    - Multi-AZ deployment across ${length(var.availability_zones)} availability zones
    - Log retention: ${var.log_retention_days} days
    - Benchmark: DISABLED (use bench environment for testing)
